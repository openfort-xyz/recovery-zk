...
uint256 constant N = 262_144;
uint256 constant LOG_N = 18;
uint256 constant NUMBER_OF_PUBLIC_INPUTS = 36;
uint256 constant VK_HASH = 0x1435e921cfdca3377519dc405ea971a178f35c7b76f9c40d8f04c470fa9e1673;

library HonkVerificationKey {
    function loadVerificationKey() internal pure returns (Honk.VerificationKey memory) {
        Honk.VerificationKey memory vk = Honk.VerificationKey({
            circuitSize: uint256(262_144),
            logCircuitSize: uint256(18),
            publicInputsSize: uint256(36),
            ql: Honk.G1Point({
                x: uint256(0x0d82b6e6a550830c0fe93050fc24ecc457839b59fce0e21efe121466f47cdb5a),
                y: uint256(0x2fec3f4763433c66c9dcedf6e95788ce813301aaa965f66ffe8199c558973bf6)
            }),
            qr: Honk.G1Point({
                x: uint256(0x1d6e3269832b1393fb8ee8ae17d826f75c78a47c7ee60c04d2faf70ff4ad3f28),
                y: uint256(0x1b86015ecb0a2d4e7c96138fd764cc474558684d45d5c24abc48a534a93efe4d)
            }),
            qo: Honk.G1Point({
                x: uint256(0x28e7260ace4a2c2bed92d555d3a176e0e72409fd3aebb85f84fdc5e0965a4ed5),
                y: uint256(0x19eca8bb306d30b2708f7e7a2676c78637e32017e0907396199afe9c06375bde)
            }),
            q4: Honk.G1Point({
                x: uint256(0x1373467a766302efa25b0d19b91b767c4ff463b5bb3c17a898542a9feb380afe),
                y: uint256(0x2365d8742b100d4d6abd47bfe9825c5365c3ce065c85d993ce84952334adf95e)
            }),
            qm: Honk.G1Point({
                x: uint256(0x1ca4354d719371db3325ebd894bd965d5049af6e66fcf6fffe43bd041c6cae7f),
                y: uint256(0x20f6828386b4d5cce6062d61e9bbd6c338bacaf68b8a466e34bb99f1c89e827b)
            }),
            qc: Honk.G1Point({
                x: uint256(0x1775b3d3c9edc1598b46577e7820ea85a3785a1ad2e98eceaa118bf2a7861754),
                y: uint256(0x20f250f299558820d4a07ea774a0c6b786f728cdb20d5eb8a30e989325be4c5e)
            }),
            qLookup: Honk.G1Point({
                x: uint256(0x1ca4b36c72a2943ff831a09e220fdbc43bcbb1432c5ef445156604fd895512c1),
                y: uint256(0x072e1493c6f207f45e6c8bfa0897dc5e0d90a9d1af8d81c97054abf188c0727f)
            }),
            qArith: Honk.G1Point({
                x: uint256(0x1599375833d8c51bfb13f9b27d153164fbc0db9ddde49dcdfaebbcba55ee5f0c),
                y: uint256(0x1b76fa7545564e28d4495ce6dab0ded555df42c696a5bfca01ba903d0b364a3f)
            }),
            qDeltaRange: Honk.G1Point({
                x: uint256(0x02653282d0d3f2846129530dc7e3476456309873277f071dcec235f763725c76),
                y: uint256(0x20f0e6f2b1e3c1ffb0b7af4c4634561c0cb79bbfdfae5b81b5287a1a4603ff19)
            }),
            qElliptic: Honk.G1Point({
                x: uint256(0x1da118f48171957695c855a2f7e3107a7cb044eaf16c0237b83d654810a01393),
                y: uint256(0x2981bbdcd6b18985343d0a283f2a8115efa9301e162f17a37d128df1d3b5c932)
            }),
            qMemory: Honk.G1Point({
                x: uint256(0x12b8ada6f38fc7dbf55ce12898ef41a253550c8a0cc0057dbba70939c9aaa3a2),
                y: uint256(0x06a7de40e4032eca7fed57d1b2146a5365e9b553dd531fed0a0fa3f775a898cb)
            }),
            qNnf: Honk.G1Point({
                x: uint256(0x132234598f1b5f3ed11a36206dc39e4b6fc39c3666d34033703d1271c189b062),
                y: uint256(0x1df060045eecc7319c366a17821e0bfbe6175613101f20f0363d8b382939559b)
            }),
            qPoseidon2External: Honk.G1Point({
                x: uint256(0x1eec0be543b5633469dc8f62eb9910a56311495610e5dd607baa882b498ce341),
                y: uint256(0x278814cf1576bee8a85a26e3f44d03a5a455e91b24f3de99b7974be462313a50)
            }),
            qPoseidon2Internal: Honk.G1Point({
                x: uint256(0x10748023fc4cf8151cfc2363afad9bd9fc0ba92ac6cb9af96232bcbe56ca0215),
                y: uint256(0x2b8ee4cb3353d252475e45f5b30b8d8c4b497942069d2fd6f4f83541992ad2ca)
            }),
            s1: Honk.G1Point({
                x: uint256(0x2dfe2a97a0bff066b72c5f18f4a9fd4d16f5df0f935c891139c7b6aa68631311),
                y: uint256(0x16c0dd1029368719958ae14b474cd5d2524a23acb0a544bf125f41736d04ac51)
            }),
            s2: Honk.G1Point({
                x: uint256(0x0c2fe0e6252cc5c21cd341e0780ecd2b5962f0f7414af2b64c056add80298ba8),
                y: uint256(0x228ee67eacce0df01d0bc0765b9212d44b13855402d3ca77312249ea50cc502a)
            }),
            s3: Honk.G1Point({
                x: uint256(0x26817841abcd2ed3a7c2808b392b7cc2fc9d750532c5408713d50ce55ae91a54),
                y: uint256(0x05ce98fbfe568e43653a8e2c539e180f926e39ef763c69d1c026d7ef1f1c2820)
            }),
            s4: Honk.G1Point({
                x: uint256(0x10140c2ded8fac33a279509b1693d720c62bfe93c5cce0c9a93e8cabfbba4cb8),
                y: uint256(0x27cc1da8556deac997a83a414008649e2c85fe482321bd892de1a45c0156f36c)
            }),
            t1: Honk.G1Point({
            ...
            t3: Honk.G1Point({
                x: uint256(0x1c87d112f4f2a05269ff6ffe553d69d7c0c94a47c8ea795b876db23f9fac0856),
                y: uint256(0x0395dc40aba865aaf1109997fe9b156dedbb854a45d7b794c26cf116c03fbd10)
            }),
            t4: Honk.G1Point({
            ...
            id1: Honk.G1Point({
                x: uint256(0x2d2c3c39378429eb458163596558c98802a0a85e94551e08cc15d1b9d301f037),
                y: uint256(0x0774a35cc41e5ca62e82bb71d9d91cf3d324564c784bae2890829f2a59e64a65)
            }),
            id2: Honk.G1Point({
                x: uint256(0x2c45f4a1960dc5709db13d5824b0cd8a7c2b7f1ed370de222d15043eb60ecade),
                y: uint256(0x2056950bfe22f0e78de3148f0b20b707099ea90c681bf54a4f08ebd3fdef3c7f)
            }),
            id3: Honk.G1Point({
                x: uint256(0x181a934698c9a8e2b2124aa6ad357921a1a34e64061be53d6e3cf83a8ba758e2),
                y: uint256(0x1d65fdc5152ac7b04055882d9cd6f38a4f7150640632159f5f406731ea0c10d3)
            }),
            id4: Honk.G1Point({
                x: uint256(0x0b7b0386a862720ab331db1d5e51ac4430a940ed75a537128e67c5408cc74f9f),
                y: uint256(0x09209e132fa5cd154e18d62472f61e0e122109a0ca047dce5cd013fb54c7f5c5)
            }),
            ...
            lagrangeLast: Honk.G1Point({
                x: uint256(0x1692c39cc1292d10908c397abf30569071bb11ee53ab438c9777ea665249ea5c),
                y: uint256(0x2c2571dcc6a671158588e344e98131410214d0767356dddbf3ec062e828a4894)
            })
        });
        return vk;
    }
...
library RelationsLib {
        ...
        pure
    {
        ...
        ap.adjacent_values_match_if_adjacent_indices_match = (ap.index_delta * MINUS_ONE + ONE) * ap.record_delta; // deg
        // 2
        ...
        ap.adjacent_values_match_if_adjacent_indices_match_and_next_access_is_a_read_operation =
            (ap.index_delta * MINUS_ONE + ONE) * value_delta * (ap.next_gate_access_type * MINUS_ONE + ONE); // deg 3 or
        // 6
        ...
        evals[17] = ap.index_is_monotonically_increasing * (wire(p, WIRE.Q_O)) * (wire(p, WIRE.Q_MEMORY) * domainSep); // deg
        // 4
        evals[18] = ap.next_gate_access_type_is_boolean * (wire(p, WIRE.Q_O)) * (wire(p, WIRE.Q_MEMORY) * domainSep); // deg
        // 4 or 6
        ...
        ap.RAM_timestamp_check_identity = (ap.index_delta * MINUS_ONE + ONE) * ap.timestamp_delta - wire(p, WIRE.W_O); // deg
        // 3
...
abstract contract BaseZKHonkVerifier is IZKVerifier {
    using FrLib for Fr;
    ...
    function verifySumcheck(Honk.ZKProof memory proof, ZKTranscript memory tp) internal view returns (bool verified) {
        ...
        for (uint256 i = 0; i < NUMBER_OF_ENTITIES; i++) {
            relationsEvaluations[i] = proof.sumcheckEvaluations[i + NUM_MASKING_POLYNOMIALS]; // Skip
            // gemini_masking_poly at index 0
        }
